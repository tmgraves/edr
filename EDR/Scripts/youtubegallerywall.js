		...
		return this.each(function(){ //return jQuery obj
			...
			$lis.each(function(i){
				...
				$li.html(
					'<div class="thumbwrap">'
					+ '<img src="' + thumbnail + '" />'
					+ '<div class="panel"><div class="panelinner"><i class="glyphicon-play-circle fa fa-play-circle-o"></i> <a class="externallink fa fa-external-link-square" href="' + doclink + '"></a></div></div>'
					+ '</div>'
