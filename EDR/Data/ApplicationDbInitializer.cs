...
namespace EDR.Data
{
    public class ApplicationDbInitializer : DropCreateDatabaseIfModelChanges<ApplicationDbContext>
    {
        protected override void Seed(ApplicationDbContext context)
        {
            ...
            var salsaIxSalClassSeries = new ClassSeries() { Name = "Learn to salsa", Description = "Learn the basics of Salsa dancing.  Meet fun people in the process.  Stick around for social dancing to try out your new moves!", DanceStyles = new List<DanceStyle> { styles[0] }, Place = places[14], StartDate = Convert.ToDateTime("7/29/14 8:00pm"), EndDate = DateTime.Today.AddYears(1), Price = 10, IsAvailable = true, Prerequisite = "None", SkillLevel = 1, Teachers = new List<Teacher> { tchr }, Frequency = Frequency.Weekly, Day = DayOfWeek.Tuesday, Time = new TimeSpan(20, 00, 00), EndTime = new TimeSpan(21, 00, 00) };
            var salsaGraBacClassSeries = new ClassSeries() { Name = "Bachata Class", Description = "Learn to dance Bachata.  Learn footwork, partnering, and styling techniques.  And stick around for social afterward.", DanceStyles = new List<DanceStyle> { styles[2] }, Place = places[13], StartDate = Convert.ToDateTime("7/29/14 9:00pm"), EndDate = DateTime.Today.AddYears(1), Price = 15, IsAvailable = true, Prerequisite = "None", SkillLevel = 2, Teachers = new List<Teacher> { tchr }, Frequency = Frequency.Weekly, Day = DayOfWeek.Tuesday, Time = new TimeSpan(21, 00, 00), EndTime = new TimeSpan(22, 00, 00) };
            var salsaDDBacClassSeries = new ClassSeries() { Name = "Advanced Bachata", Description = "Learn advanced bachata techniques, styling, and patterns.  Must have solid understanding of basic and intermediate bachata skills.", DanceStyles = new List<DanceStyle> { styles[2] }, Place = places[12], StartDate = Convert.ToDateTime("7/30/14 7:00pm"), EndDate = DateTime.Today.AddYears(1), Price = 15, IsAvailable = true, Prerequisite = "Beginner and Intermediate Bachata", SkillLevel = 3, Teachers = new List<Teacher> { tchr }, Frequency = Frequency.Weekly, Day = DayOfWeek.Wednesday, Time = new TimeSpan(19, 00, 00), EndTime = new TimeSpan(20, 00, 00) };
