    ...
    public class ApplicationDbInitializer : CreateDatabaseIfNotExists<ApplicationDbContext>
    {
        protected override void Seed(ApplicationDbContext context)
        {
            ...
            var events = new List<Event>()
            {
                ...
                new Social() { SocialType = Enums.SocialType.Social, Name = "Wednesday Salsa Social", Description = "Monsoon Social", Place = places[10], StartDate = Convert.ToDateTime("7/23/14 8:00 PM"), EndDate = Convert.ToDateTime("7/24/14 2:00 AM"), Price = 12, IsAvailable = true, DanceStyles=latinstyles, Duration=ApplicationUtility.CalculateTime(0, 5, 0), Recurring=true, Frequency=Frequency.Weekly, Interval=1, Promoters = proms },
                new Social() { SocialType = Enums.SocialType.Social, Name = "Noypitz Social", Description = "Noypitz Social", Place = places[11], StartDate = Convert.ToDateTime("7/27/14 8:00 PM"), EndDate = Convert.ToDateTime("7/28/14 2:00 AM"), Price = 7, IsAvailable = true, DanceStyles=latinstyles, Duration=ApplicationUtility.CalculateTime(0, 5, 0), Recurring=true, Frequency=Frequency.Weekly, Interval=1, Promoters = proms },
            ...
            salsaclasses.Add(new Class() { Name = "Advanced Salsa Class", Description = "Learn advanced Salsa techniques.  Learn better footwork, spins, styling.  This is a very challenging advanced class, so prerequisite is to have a firm understanding of beginnner and intermediate Salsa techniques and footwork.  For more information, ask the instructor.", DanceStyles = new List<DanceStyle> { styles[0] }, Place = places[6], StartDate = Convert.ToDateTime("7/28/14 8:00pm"), EndDate = null, Price = 15, IsAvailable = true, Prerequisite = "Beginner and Intermediate Salsa", SkillLevel = (SkillLevel)4, Teachers = new List<Teacher> { tchr }, Duration = ApplicationUtility.CalculateTime(0, 1, 0), Recurring = true, Frequency = Frequency.Weekly, Interval = 1, ClassType = Enums.ClassType.Class });
            salsaclasses.Add(new Class() { Name = "Learn to salsa", Description = "Learn the basics of Salsa dancing.  Meet fun people in the process.  Stick around for social dancing to try out your new moves!", DanceStyles = new List<DanceStyle> { styles[0] }, Place = places[14], StartDate = Convert.ToDateTime("7/29/14 8:00pm"), EndDate = null, Price = 10, IsAvailable = true, Prerequisite = "None", SkillLevel = (SkillLevel)1, Teachers = new List<Teacher> { tchr2 }, Duration = ApplicationUtility.CalculateTime(0, 1, 0), Recurring = true, Frequency = Frequency.Weekly, Interval = 1, ClassType = Enums.ClassType.Class });
            salsaclasses.Add(new Class() { Name = "Bachata Class", Description = "Learn to dance Bachata.  Learn footwork, partnering, and styling techniques.  And stick around for social afterward.", DanceStyles = new List<DanceStyle> { styles[2] }, Place = places[13], StartDate = Convert.ToDateTime("7/29/14 9:00pm"), EndDate = null, Price = 15, IsAvailable = true, Prerequisite = "None", SkillLevel = (SkillLevel)2, Teachers = new List<Teacher> { tchr, tchr2 }, Duration = ApplicationUtility.CalculateTime(0, 1, 0), Recurring = true, Frequency = Frequency.Weekly, Interval = 1, ClassType = Enums.ClassType.Class });
            salsaclasses.Add(new Class() { Name = "Advanced Bachata", Description = "Learn advanced bachata techniques, styling, and patterns.  Must have solid understanding of basic and intermediate bachata skills.", DanceStyles = new List<DanceStyle> { styles[2] }, Place = places[12], StartDate = Convert.ToDateTime("7/30/14 7:00pm"), EndDate = null, Price = 15, IsAvailable = true, Prerequisite = "Beginner and Intermediate Bachata", SkillLevel = (SkillLevel)3, Teachers = new List<Teacher> { tchr2 }, Duration = ApplicationUtility.CalculateTime(0, 1, 0), Recurring = true, Frequency = Frequency.Weekly, Interval = 1, ClassType = Enums.ClassType.Class });
            salsaclasses.Add(new Class() { Name = "Daily Salsa", Description = "Learn Salsa Everyday", DanceStyles = new List<DanceStyle> { styles[2] }, Place = places[12], StartDate = Convert.ToDateTime("12/1/14 8:00pm"), EndDate = Convert.ToDateTime("3/1/15 9:00pm"), Price = 10, IsAvailable = true, Prerequisite = "Beginner Salsa", SkillLevel = (SkillLevel)1, Teachers = new List<Teacher> { tchr2 }, Duration = ApplicationUtility.CalculateTime(0, 1, 0), Recurring = true, Frequency = Frequency.Daily, Interval = 1, ClassType = Enums.ClassType.Class });

            var socials = new List<Social>();
            socials.Add(new Social() { SocialType = Enums.SocialType.Social, Name = "Wednesday Salsa Social", Description = "Monsoon Social", Place = places[1], StartDate = Convert.ToDateTime("7/23/14 8:00pm"), EndDate = null, Price = 0, IsAvailable = true, DanceStyles = latinstyles, Duration = ApplicationUtility.CalculateTime(0, 5, 0), Recurring = true, Frequency = Frequency.Weekly, Interval = 1, Promoters = proms });
