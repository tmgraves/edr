...
namespace EDR.Data
{
    public class ApplicationDbInitializer : DropCreateDatabaseIfModelChanges<ApplicationDbContext>
    {
        protected override void Seed(ApplicationDbContext context)
        {
            ...
            {
                new Concert() { Name = "Marc Anthony", Description = "Marc Anthony in concert", Place = places[4], StartDate = Convert.ToDateTime("9/22/2014 8:00 PM"), EndDate = Convert.ToDateTime("9/23/2014 1:00 AM"), Price = 50, IsAvailable = true, DanceStyles=latinstyles, Time=new DateTime(2014, 1, 1, 20, 0, 0), Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false },
                new Concert() { Name = "Romeo Santos", Description = "Romeo Santos in concert", Place = places[5], StartDate = Convert.ToDateTime("10/22/14 9:00 PM"), EndDate = Convert.ToDateTime("10/23/14 12:00 AM"), Price = 85, IsAvailable = true, DanceStyles=new List<DanceStyle> { styles[2]}, Time=new DateTime(2014, 1, 1, 21, 0, 0), Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false },
                new Conference() { Name = "LA Salsa Congress", Description = "LA Salsa Congress", Place = places[2], StartDate = Convert.ToDateTime("5/23/14 6:00 PM"), EndDate = Convert.ToDateTime("5/27/14 6:00 AM"), Price = 340, IsAvailable = true, DanceStyles=latinstyles, Time=new DateTime(2014, 1, 1,18,0,0), Duration=ApplicationUtility.CalculateTime(3, 0, 0), Recurring=false },
                new Conference() { Name = "LA Bachata Festival", Description = "LA Bachata Festival", Place = places[3], StartDate = Convert.ToDateTime("8/15/14 6:00 PM"), EndDate = Convert.ToDateTime("8/19/14 6:00 AM"), Price = 250, IsAvailable = true, DanceStyles=latinstyles, Time=new DateTime(2014, 1, 1,20,0,0), Duration=ApplicationUtility.CalculateTime(3, 0, 0), Recurring=false },
                new OpenHouse() { Name = "Summer Open House", Description = "Summer Open House", Place = places[6], StartDate = Convert.ToDateTime("7/30/14 6:00 PM"), EndDate = Convert.ToDateTime("7/31/14 2:00 AM"), Price = 0, IsAvailable = true, DanceStyles=styles, Time=new DateTime(2014, 1, 1,18,0,0), Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false },
                new OpenHouse() { Name = "Dance Showcase", Description = "Dance Showcase", Place = places[7], StartDate = Convert.ToDateTime("9/15/14 6:00 PM"), EndDate = Convert.ToDateTime("9/16/14 2:00 AM"), Price = 0, IsAvailable = true, DanceStyles=styles, Time=new DateTime(2014, 1, 1,19,0,0), Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false },
                new Social() { Name = "Wednesday Salsa Social", Description = "Monsoon Social", Place = places[10], StartDate = Convert.ToDateTime("7/23/14 8:00 PM"), EndDate = Convert.ToDateTime("7/24/14 2:00 AM"), Price = 12, IsAvailable = true, DanceStyles=latinstyles, Time=new DateTime(2014, 1, 1,21,0,0), Duration=ApplicationUtility.CalculateTime(0, 5, 0), Recurring=true, Frequency=Frequency.Weekly, Day=DayOfWeek.Wednesday, Interval=1 },
                new Social() { Name = "Noypitz Social", Description = "Noypitz Social", Place = places[11], StartDate = Convert.ToDateTime("7/27/14 8:00 PM"), EndDate = Convert.ToDateTime("7/28/14 2:00 AM"), Price = 7, IsAvailable = true, DanceStyles=latinstyles, Time=new DateTime(2014, 1, 1,21,0,0), Duration=ApplicationUtility.CalculateTime(0, 5, 0), Recurring=true, Frequency=Frequency.Weekly, Day=DayOfWeek.Sunday, Interval=1  },
                new Workshop() { Name = "Pachanga Bootcamp", Description = "Pachanga Bootcamp", Place = places[8], StartDate = Convert.ToDateTime("7/26/14 2:00 PM"), EndDate = Convert.ToDateTime("7/26/14 6:00 PM"), Price = 50, IsAvailable = true, DanceStyles=new List<DanceStyle> { styles[1] }, Time=new DateTime(2014, 1, 1,12,0,0), Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false },
                new Workshop() { Name = "Bachata Bootcamp", Description = "Bachata Bootcamp", Place = places[9], StartDate = Convert.ToDateTime("8/26/14 2:00 PM"), EndDate = Convert.ToDateTime("8/26/14 6:00 PM"), Price = 40, IsAvailable = true, DanceStyles=new List<DanceStyle> { styles[2] }, Time=new DateTime(2014, 1, 1,21,0,0), Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false },
                new Party() { Name = "Joe's Birthday", Description = "Joe's Birthday", Place = places[11], StartDate = Convert.ToDateTime("9/26/14 2:00 PM"), EndDate = Convert.ToDateTime("9/26/14 6:00 PM"), Price = 10, IsAvailable = true, DanceStyles=latinstyles, Time=new DateTime(2014, 1, 1,20,0,0), Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false },
                
                new Class() { Name = "Beginners salsa", Description = "Learn salsa with a step by step, fun and social salsa lessons.", DanceStyles=new List<DanceStyle> { styles[0] } , Place = places[6], StartDate = DateTime.Today.AddDays(4), EndDate = DateTime.Today.AddDays(4), Price = 10, IsAvailable = true, Time=new DateTime(2014, 1, 1,20,0,0), Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false },
                new Class() { Name = "Enjoy salsa", Description = "Enjoy salsa with a step by step, fun and social salsa lessons that will have you smiling.", DanceStyles=new List<DanceStyle> { styles[1] } , Place = places[7], StartDate = DateTime.Today.AddDays(12), EndDate = DateTime.Today.AddDays(12), Price = 15, IsAvailable = true, Time=new DateTime(2014, 1, 1,20,0,0), Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false },
                new Class() { Name = "Salsa workout", Description = "Get a workout with this fun and social salsa lessons that has everyone sweating.", DanceStyles=new List<DanceStyle> { styles[1] } , Place = places[7], StartDate = DateTime.Today.AddDays(13), EndDate = DateTime.Today.AddDays(13), Price = 20, IsAvailable = true, Time=new DateTime(2014, 1, 1,20,0,0), Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false },
                new Class() { Name = "Salsa bootcamp", Description = "Salsa bootcamp is a step by step, fun and social salsa lessons that get everyone dancing.", DanceStyles=new List<DanceStyle> { styles[1] } , Place = places[7], StartDate = DateTime.Today.AddDays(17), EndDate = DateTime.Today.AddDays(17), Price = 25, IsAvailable = true, Time=new DateTime(2014, 1, 1,20,0,0), Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false },
                new Class() { Name = "Learn Bachata", Description = "Learn the bachata with experienced instructors and great music.", DanceStyles=new List<DanceStyle> { styles[2] } , Place = places[10], StartDate = DateTime.Today.AddDays(19), EndDate = DateTime.Today.AddDays(19), Price = 5, IsAvailable = true, Time=new DateTime(2014, 1, 1,20,0,0), Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false },
                new Class() { Name = "Cha cha cha with us", Description = "Get out here and cha cha cha with an exciting group of dancers.", DanceStyles=new List<DanceStyle> { styles[3] } , Place = places[11], StartDate = DateTime.Today.AddDays(25), EndDate = DateTime.Today.AddDays(25), Price = 5, IsAvailable = true, Time=new DateTime(2014, 1, 1,20,0,0), Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false },
                new Class() { Name = "Learn to tango", Description = "No better time them now to learn to tango.", DanceStyles=new List<DanceStyle> { styles[4] } , Place = places[10], StartDate = DateTime.Today.AddDays(31), EndDate = DateTime.Today.AddDays(31), Price = 10, IsAvailable = true, Time=new DateTime(2014, 1, 1,20,0,0), Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false },
                new Class() { Name = "Master the mambo", Description = "Great mambo class for intermediate to advanced mambo'rs.", DanceStyles=new List<DanceStyle> { styles[5] } , Place = places[11], StartDate = DateTime.Today.AddDays(45), EndDate = DateTime.Today.AddDays(45), Price = 10, IsAvailable = true, Time=new DateTime(2014, 1, 1,20,0,0), Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false }
            };
            ...
            salsaclasses.Add(new Class() { Name = "Advanced Salsa Class", Description = "Learn advanced Salsa techniques.  Learn better footwork, spins, styling.  This is a very challenging advanced class, so prerequisite is to have a firm understanding of beginnner and intermediate Salsa techniques and footwork.  For more information, ask the instructor.", DanceStyles = new List<DanceStyle> { styles[0] }, Place = places[6], StartDate = Convert.ToDateTime("7/28/14 8:00pm"), EndDate = null, Price = 15, IsAvailable = true, Prerequisite = "Beginner and Intermediate Salsa", SkillLevel = 4, Teachers = new List<Teacher> { tchr }, Time = new DateTime(2014, 1, 1,20, 00, 00), Duration = ApplicationUtility.CalculateTime(0, 1, 0), Recurring = true, Frequency = Frequency.Weekly, Day = DayOfWeek.Monday, Interval = 1 });
            salsaclasses.Add(new Class() { Name = "Learn to salsa", Description = "Learn the basics of Salsa dancing.  Meet fun people in the process.  Stick around for social dancing to try out your new moves!", DanceStyles = new List<DanceStyle> { styles[0] }, Place = places[14], StartDate = Convert.ToDateTime("7/29/14 8:00pm"), EndDate = null, Price = 10, IsAvailable = true, Prerequisite = "None", SkillLevel = 1, Teachers = new List<Teacher> { tchr2 }, Time = new DateTime(2014, 1, 1,20, 00, 00), Duration = ApplicationUtility.CalculateTime(0, 1, 0), Recurring = true, Frequency = Frequency.Weekly, Day = DayOfWeek.Tuesday, Interval = 1 });
            salsaclasses.Add(new Class() { Name = "Bachata Class", Description = "Learn to dance Bachata.  Learn footwork, partnering, and styling techniques.  And stick around for social afterward.", DanceStyles = new List<DanceStyle> { styles[2] }, Place = places[13], StartDate = Convert.ToDateTime("7/29/14 9:00pm"), EndDate = null, Price = 15, IsAvailable = true, Prerequisite = "None", SkillLevel = 2, Teachers = new List<Teacher> { tchr, tchr2 }, Time = new DateTime(2014, 1, 1,21, 00, 00), Duration = ApplicationUtility.CalculateTime(0, 1, 0), Recurring = true, Frequency = Frequency.Weekly, Day = DayOfWeek.Tuesday, Interval = 1 });
            salsaclasses.Add(new Class() { Name = "Advanced Bachata", Description = "Learn advanced bachata techniques, styling, and patterns.  Must have solid understanding of basic and intermediate bachata skills.", DanceStyles = new List<DanceStyle> { styles[2] }, Place = places[12], StartDate = Convert.ToDateTime("7/30/14 7:00pm"), EndDate = null, Price = 15, IsAvailable = true, Prerequisite = "Beginner and Intermediate Bachata", SkillLevel = 3, Teachers = new List<Teacher> { tchr2 }, Time = new DateTime(2014, 1, 1,19, 00, 00), Duration = ApplicationUtility.CalculateTime(0, 1, 0), Recurring = true, Frequency = Frequency.Weekly, Day = DayOfWeek.Wednesday, Interval = 1 });

            var socials = new List<Social>();
            socials.Add(new Social() { Name = "Wednesday Salsa Social", Description = "Monsoon Social", Place = places[1], StartDate = Convert.ToDateTime("7/23/14 8:00pm"), EndDate = null, Price = 0, IsAvailable = true, DanceStyles = latinstyles, Time = new DateTime(2014, 1, 1,21, 00, 00), Duration = ApplicationUtility.CalculateTime(0, 5, 0), Recurring = true, Frequency = Frequency.Weekly, Day = DayOfWeek.Wednesday, Interval = 1 });
            socials.Add(new Social() { Name = "Monday Zanzibar Salsa Social", Description = "Zanzibar Social", Place = places[10], StartDate = Convert.ToDateTime("7/1/14 8:00pm"), EndDate = null, Price = 0, IsAvailable = true, DanceStyles = latinstyles, Time = new DateTime(2014, 1, 1,21, 00, 00), Duration = ApplicationUtility.CalculateTime(0, 5, 0), Recurring = true, Frequency = Frequency.Weekly, Day = DayOfWeek.Monday, Interval = 1 });
