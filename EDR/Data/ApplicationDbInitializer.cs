    ...
    public class ApplicationDbInitializer : DropCreateDatabaseIfModelChanges<ApplicationDbContext>
    {
        protected override void Seed(ApplicationDbContext context)
        {
            ...
            var events = new List<Event>()
            {
                ...
                new Workshop() { Name = "Pachanga Bootcamp", Description = "Pachanga Bootcamp", Place = places[8], StartDate = Convert.ToDateTime("7/26/14 2:00 PM"), EndDate = Convert.ToDateTime("7/26/14 6:00 PM"), Price = 50, IsAvailable = true, DanceStyles=new List<DanceStyle> { styles[1] }, Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false },
                new Workshop() { Name = "Bachata Bootcamp", Description = "Bachata Bootcamp", Place = places[9], StartDate = Convert.ToDateTime("8/26/14 2:00 PM"), EndDate = Convert.ToDateTime("8/26/14 6:00 PM"), Price = 40, IsAvailable = true, DanceStyles=new List<DanceStyle> { styles[2] }, Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false },
                ...
                new Class() { Name = "Beginners salsa", Description = "Learn salsa with a step by step, fun and social salsa lessons.", DanceStyles=new List<DanceStyle> { styles[0] } , Place = places[6], StartDate = DateTime.Today.AddDays(4), EndDate = DateTime.Today.AddDays(4), Price = 10, IsAvailable = true, Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false },
                new Class() { Name = "Enjoy salsa", Description = "Enjoy salsa with a step by step, fun and social salsa lessons that will have you smiling.", DanceStyles=new List<DanceStyle> { styles[1] } , Place = places[7], StartDate = DateTime.Today.AddDays(12), EndDate = DateTime.Today.AddDays(12), Price = 15, IsAvailable = true, Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false },
                new Class() { Name = "Salsa workout", Description = "Get a workout with this fun and social salsa lessons that has everyone sweating.", DanceStyles=new List<DanceStyle> { styles[1] } , Place = places[7], StartDate = DateTime.Today.AddDays(13), EndDate = DateTime.Today.AddDays(13), Price = 20, IsAvailable = true, Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false },
                new Class() { Name = "Salsa bootcamp", Description = "Salsa bootcamp is a step by step, fun and social salsa lessons that get everyone dancing.", DanceStyles=new List<DanceStyle> { styles[1] } , Place = places[7], StartDate = DateTime.Today.AddDays(17), EndDate = DateTime.Today.AddDays(17), Price = 25, IsAvailable = true, Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false },
                new Class() { Name = "Learn Bachata", Description = "Learn the bachata with experienced instructors and great music.", DanceStyles=new List<DanceStyle> { styles[2] } , Place = places[10], StartDate = DateTime.Today.AddDays(19), EndDate = DateTime.Today.AddDays(19), Price = 5, IsAvailable = true, Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false },
                new Class() { Name = "Cha cha cha with us", Description = "Get out here and cha cha cha with an exciting group of dancers.", DanceStyles=new List<DanceStyle> { styles[3] } , Place = places[11], StartDate = DateTime.Today.AddDays(25), EndDate = DateTime.Today.AddDays(25), Price = 5, IsAvailable = true, Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false },
                new Class() { Name = "Learn to tango", Description = "No better time them now to learn to tango.", DanceStyles=new List<DanceStyle> { styles[4] } , Place = places[10], StartDate = DateTime.Today.AddDays(31), EndDate = DateTime.Today.AddDays(31), Price = 10, IsAvailable = true, Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false },
                new Class() { Name = "Master the mambo", Description = "Great mambo class for intermediate to advanced mambo'rs.", DanceStyles=new List<DanceStyle> { styles[5] } , Place = places[11], StartDate = DateTime.Today.AddDays(45), EndDate = DateTime.Today.AddDays(45), Price = 10, IsAvailable = true, Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false }
            };
            ...
            salsaclasses.Add(new Class() { Name = "Advanced Salsa Class", Description = "Learn advanced Salsa techniques.  Learn better footwork, spins, styling.  This is a very challenging advanced class, so prerequisite is to have a firm understanding of beginnner and intermediate Salsa techniques and footwork.  For more information, ask the instructor.", DanceStyles = new List<DanceStyle> { styles[0] }, Place = places[6], StartDate = Convert.ToDateTime("7/28/14 8:00pm"), EndDate = null, Price = 15, IsAvailable = true, Prerequisite = "Beginner and Intermediate Salsa", SkillLevel = 4, Teachers = new List<Teacher> { tchr }, Duration = ApplicationUtility.CalculateTime(0, 1, 0), Recurring = true, Frequency = Frequency.Weekly, Day = DayOfWeek.Monday, Interval = 1 });
            salsaclasses.Add(new Class() { Name = "Learn to salsa", Description = "Learn the basics of Salsa dancing.  Meet fun people in the process.  Stick around for social dancing to try out your new moves!", DanceStyles = new List<DanceStyle> { styles[0] }, Place = places[14], StartDate = Convert.ToDateTime("7/29/14 8:00pm"), EndDate = null, Price = 10, IsAvailable = true, Prerequisite = "None", SkillLevel = 1, Teachers = new List<Teacher> { tchr2 }, Duration = ApplicationUtility.CalculateTime(0, 1, 0), Recurring = true, Frequency = Frequency.Weekly, Day = DayOfWeek.Tuesday, Interval = 1 });
            salsaclasses.Add(new Class() { Name = "Bachata Class", Description = "Learn to dance Bachata.  Learn footwork, partnering, and styling techniques.  And stick around for social afterward.", DanceStyles = new List<DanceStyle> { styles[2] }, Place = places[13], StartDate = Convert.ToDateTime("7/29/14 9:00pm"), EndDate = null, Price = 15, IsAvailable = true, Prerequisite = "None", SkillLevel = 2, Teachers = new List<Teacher> { tchr, tchr2 }, Duration = ApplicationUtility.CalculateTime(0, 1, 0), Recurring = true, Frequency = Frequency.Weekly, Day = DayOfWeek.Tuesday, Interval = 1 });
            salsaclasses.Add(new Class() { Name = "Advanced Bachata", Description = "Learn advanced bachata techniques, styling, and patterns.  Must have solid understanding of basic and intermediate bachata skills.", DanceStyles = new List<DanceStyle> { styles[2] }, Place = places[12], StartDate = Convert.ToDateTime("7/30/14 7:00pm"), EndDate = null, Price = 15, IsAvailable = true, Prerequisite = "Beginner and Intermediate Bachata", SkillLevel = 3, Teachers = new List<Teacher> { tchr2 }, Duration = ApplicationUtility.CalculateTime(0, 1, 0), Recurring = true, Frequency = Frequency.Weekly, Day = DayOfWeek.Wednesday, Interval = 1 });
