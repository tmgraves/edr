...
namespace EDR.Data
{
    public class ApplicationDbInitializer : DropCreateDatabaseIfModelChanges<ApplicationDbContext>
    {
        protected override void Seed(ApplicationDbContext context)
        {
            ...
            {
                new Restaurant() { Name = "El Floridita", Address = "1253 Vine St", City = "Los Angeles", State = State.CA, Zip = "90038", Country = "USA", FacebookLink="https://www.facebook.com/elfloridita", Website="http://www.elfloridita.com/", Latitude=34.0940036, Longitude=-118.3276732 },
                new Restaurant() { Name = "Monsoon Cafe", Address = "1212 3rd St", City = "Santa Monica", State = State.CA, Zip = "90401", Country = "USA", FacebookLink="https://www.facebook.com/monsoonsalsanight?fref=ts&ref=br_tf", Website="https://www.facebook.com/MonsoonCafeSM", Latitude=34.0180068, Longitude=-118.4989898  },
                new Hotel() { Name = "Tropicana", Address = "3801 Las Vegas Boulevard South", City = "Las Vegas", State = State.NV, Zip = "89109", Country = "USA", FacebookLink="https://www.facebook.com/troplv", Website="http://www.troplv.com/", Latitude=36.0993783, Longitude=-115.1710285 },
                new Hotel() { Name = "Hilton", Address = "2100 E Mariposa Ave", City = "El Segundo", State = State.CA, Zip = "90245", Country = "USA", FacebookLink="https://www.facebook.com/HiltonLAX", Website="http://www.hilton.com/AirportLAX", Latitude=33.9230119, Longitude=-118.3882593 },
                new Theater() { Name = "Nokia", Address = "777 Chick Hearn Ct", City = "Los Angeles", State = State.CA, Zip = "90015", Country = "USA", FacebookLink="https://www.facebook.com/nokiala", Website="http://www.nokiatheatrelalive.com/", Latitude=34.0444109, Longitude=-118.2671817 },
                new Theater() { Name = "Hollywood Bowl", Address = "2301 N Highland Ave", City = "Los Angeles", State = State.CA, Zip = "90068", Country = "USA", FacebookLink="https://www.facebook.com/HollywoodBowl", Website="http://www.hollywoodbowl.com/", Latitude=34.1127392, Longitude=-118.3388562 },
                new Studio() { Name = "3rd Street Dance", Address = "8558 W 3rd St", City = "Los Angeles", State = State.CA, Zip = "90048", Country = "USA", FacebookLink="https://www.facebook.com/3rdstreetdance", Website="http://www.thirdstreetdance.com/", Latitude=34.0734289, Longitude=-118.378875 },
                new Studio() { Name = "Karavan", Address = "1626 S Central Ave", City = "Glendale", State = State.CA, Zip = "91204", Country = "USA", FacebookLink="https://www.facebook.com/pages/Karavan-Dance-Studio/160508247306728", Website="http://karavandancestudio.com", Latitude=34.125949, Longitude= -118.258768 },
                new ConferenceCenter() { Name = "LA Convention Center", Address = "1201 S Figueroa St", City = "Los Angeles", State = State.CA, Zip = "90015", Country = "USA", FacebookLink="https://www.facebook.com/ConventionLA", Website="http://www.lacclink.com", Latitude=34.0401988, Longitude=-118.2695539 },
                new ConferenceCenter() { Name = "Anaheim Convention Center", Address = "800 W Katella Ave", City = "Anaheim", State = State.CA, Zip = "92802", Country = "USA", FacebookLink="https://www.facebook.com/AnaheimConventionCenter", Website="http://www.anaheimconventioncenter.com/", Latitude=33.8023925, Longitude=-117.9197896 },
                new Nightclub() { Name = "Zanzibar", Address = "1301 5th St", City = "Santa Monica", State = State.CA, Zip = "90401", Country = "USA", FacebookLink="https://www.facebook.com/ZanzibarLive", Website="http://www.zanzibarlive.com/", Latitude=34.0185112, Longitude=-118.4957764 },
                new Nightclub() { Name = "Mayan", Address = "1038 S Hill St", City = "Los Angeles", State = State.CA, Zip = "90015", Country = "USA", FacebookLink="https://www.facebook.com/the.mayan.la", Website="http://www.clubmayan.com/", Latitude=34.0405126, Longitude=-118.259096 },
                new Studio() { Name = "Dance Doctor", Address = "1440 4th St", City = "Santa Monica", State = State.CA, Zip = "90401", Country = "USA", FacebookLink="https://www.facebook.com/JohnCasseseTheDanceDoctor", Website="http://www.dancedoctor.com/", Latitude=34.0153142, Longitude=-118.4943285 },
                new Studio() { Name = "Granada", Address = "17 S 1st St", City = "Alhambra", State = State.CA, Zip = "91801", Country = "USA", FacebookLink="https://www.facebook.com/TheGranadaLAAlhambra", Website="http://www.thegranadala.com/", Latitude=34.09399, Longitude=-118.1276339 },
                new Nightclub() { Name = "Ixtapa", Address = "119 E Colorado Blvd", City = "Pasadena", State = State.CA, Zip = "91105", Country = "USA", FacebookLink="https://www.facebook.com/pages/IXTAPA-LOUNGE/188629852685", Website="http://www.cantinaixtapa.com/", Latitude=34.1459776, Longitude=-118.1477956 }
            };

            var events = new List<Event>()
            {
                new Concert() { Name = "Marc Anthony", Description = "Marc Anthony in concert", Place = places[4], StartDate = Convert.ToDateTime("9/22/2014 8:00 PM"), EndDate = Convert.ToDateTime("9/23/2014 1:00 AM"), Price = 50, IsAvailable = true, DanceStyles=latinstyles, Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false },
                new Concert() { Name = "Romeo Santos", Description = "Romeo Santos in concert", Place = places[5], StartDate = Convert.ToDateTime("10/22/14 9:00 PM"), EndDate = Convert.ToDateTime("10/23/14 12:00 AM"), Price = 85, IsAvailable = true, DanceStyles=new List<DanceStyle> { styles[2]}, Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false },
                new Conference() { Name = "LA Salsa Congress", Description = "LA Salsa Congress", Place = places[2], StartDate = Convert.ToDateTime("5/23/14 6:00 PM"), EndDate = Convert.ToDateTime("5/27/14 6:00 AM"), Price = 340, IsAvailable = true, DanceStyles=latinstyles, Duration=ApplicationUtility.CalculateTime(3, 0, 0), Recurring=false },
                new Conference() { Name = "LA Bachata Festival", Description = "LA Bachata Festival", Place = places[3], StartDate = Convert.ToDateTime("8/15/14 6:00 PM"), EndDate = Convert.ToDateTime("8/19/14 6:00 AM"), Price = 250, IsAvailable = true, DanceStyles=latinstyles, Duration=ApplicationUtility.CalculateTime(3, 0, 0), Recurring=false },
                new OpenHouse() { Name = "Summer Open House", Description = "Summer Open House", Place = places[6], StartDate = Convert.ToDateTime("7/30/14 6:00 PM"), EndDate = Convert.ToDateTime("7/31/14 2:00 AM"), Price = 0, IsAvailable = true, DanceStyles=styles, Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false },
                new OpenHouse() { Name = "Dance Showcase", Description = "Dance Showcase", Place = places[7], StartDate = Convert.ToDateTime("9/15/14 6:00 PM"), EndDate = Convert.ToDateTime("9/16/14 2:00 AM"), Price = 0, IsAvailable = true, DanceStyles=styles, Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false },
                new Social() { Name = "Wednesday Salsa Social", Description = "Monsoon Social", Place = places[10], StartDate = Convert.ToDateTime("7/23/14 8:00 PM"), EndDate = Convert.ToDateTime("7/24/14 2:00 AM"), Price = 12, IsAvailable = true, DanceStyles=latinstyles, Duration=ApplicationUtility.CalculateTime(0, 5, 0), Recurring=true, Frequency=Frequency.Weekly, Day=DayOfWeek.Wednesday, Interval=1 },
                new Social() { Name = "Noypitz Social", Description = "Noypitz Social", Place = places[11], StartDate = Convert.ToDateTime("7/27/14 8:00 PM"), EndDate = Convert.ToDateTime("7/28/14 2:00 AM"), Price = 7, IsAvailable = true, DanceStyles=latinstyles, Duration=ApplicationUtility.CalculateTime(0, 5, 0), Recurring=true, Frequency=Frequency.Weekly, Day=DayOfWeek.Sunday, Interval=1 },
                new Class() { Name = "Pachanga Bootcamp", Description = "Pachanga Bootcamp", Place = places[8], StartDate = Convert.ToDateTime("7/26/14 2:00 PM"), EndDate = Convert.ToDateTime("7/26/14 6:00 PM"), Price = 50, IsAvailable = true, DanceStyles=new List<DanceStyle> { styles[1] }, Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false, ClassType = Enums.ClassType.Workshop },
                new Class() { Name = "Bachata Bootcamp", Description = "Bachata Bootcamp", Place = places[9], StartDate = Convert.ToDateTime("8/26/14 2:00 PM"), EndDate = Convert.ToDateTime("8/26/14 6:00 PM"), Price = 40, IsAvailable = true, DanceStyles=new List<DanceStyle> { styles[2] }, Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false, ClassType = Enums.ClassType.Workshop },
                new Party() { Name = "Joe's Birthday", Description = "Joe's Birthday", Place = places[11], StartDate = Convert.ToDateTime("9/26/14 2:00 PM"), EndDate = Convert.ToDateTime("9/26/14 6:00 PM"), Price = 10, IsAvailable = true, DanceStyles=latinstyles, Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false },
                
                new Class() { Name = "Beginners salsa", Description = "Learn salsa with a step by step, fun and social salsa lessons.", DanceStyles=new List<DanceStyle> { styles[0] } , Place = places[6], StartDate = DateTime.Today.AddDays(4), EndDate = DateTime.Today.AddDays(4), Price = 10, IsAvailable = true, Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false, ClassType = Enums.ClassType.Class },
                new Class() { Name = "Enjoy salsa", Description = "Enjoy salsa with a step by step, fun and social salsa lessons that will have you smiling.", DanceStyles=new List<DanceStyle> { styles[1] } , Place = places[7], StartDate = DateTime.Today.AddDays(12), EndDate = DateTime.Today.AddDays(12), Price = 15, IsAvailable = true, Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false, ClassType = Enums.ClassType.Class  },
                ...
                new Class() { Name = "Salsa bootcamp", Description = "Salsa bootcamp is a step by step, fun and social salsa lessons that get everyone dancing.", DanceStyles=new List<DanceStyle> { styles[1] } , Place = places[7], StartDate = DateTime.Today.AddDays(17), EndDate = DateTime.Today.AddDays(17), Price = 25, IsAvailable = true, Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false, ClassType = Enums.ClassType.Class  },
                new Class() { Name = "Learn Bachata", Description = "Learn the bachata with experienced instructors and great music.", DanceStyles=new List<DanceStyle> { styles[2] } , Place = places[10], StartDate = DateTime.Today.AddDays(19), EndDate = DateTime.Today.AddDays(19), Price = 5, IsAvailable = true, Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false, ClassType = Enums.ClassType.Class  },
                ...
                new Class() { Name = "Learn to tango", Description = "No better time them now to learn to tango.", DanceStyles=new List<DanceStyle> { styles[4] } , Place = places[10], StartDate = DateTime.Today.AddDays(31), EndDate = DateTime.Today.AddDays(31), Price = 10, IsAvailable = true, Duration=ApplicationUtility.CalculateTime(0, 4, 0), Recurring=false, ClassType = Enums.ClassType.Class  },
            ...
            socials.Add(new Social() { Name = "Wednesday Salsa Social", Description = "Monsoon Social", Place = places[1], StartDate = Convert.ToDateTime("7/23/14 8:00pm"), EndDate = null, Price = 0, IsAvailable = true, DanceStyles = latinstyles, Duration = ApplicationUtility.CalculateTime(0, 5, 0), Recurring = true, Frequency = Frequency.Weekly, Day = DayOfWeek.Wednesday, Interval = 1 });
            socials.Add(new Social() { Name = "Monday Zanzibar Salsa Social", Description = "Zanzibar Social", Place = places[10], StartDate = Convert.ToDateTime("7/1/14 8:00pm"), EndDate = null, Price = 0, IsAvailable = true, DanceStyles = latinstyles, Duration = ApplicationUtility.CalculateTime(0, 5, 0), Recurring = true, Frequency = Frequency.Weekly, Day = DayOfWeek.Monday, Interval = 1 });
