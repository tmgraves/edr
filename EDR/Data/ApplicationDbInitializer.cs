...
namespace EDR.Data
{
    public class ApplicationDbInitializer : DropCreateDatabaseIfModelChanges<ApplicationDbContext>
    {
        protected override void Seed(ApplicationDbContext context)
        {
            ...
            var salsaworkshops = new List<Workshop>();

            //  Seed Workshops
            salsaworkshops.Add(new Workshop() { Name = "Ladies Styling", Description = "Learn advanced styling techniques.", DanceStyles = new List<DanceStyle> { styles[0] }, Place = places[6], StartDate = Convert.ToDateTime("9/7/14 8:00pm"), EndDate = Convert.ToDateTime("9/28/14 8:00pm"), Price = 22, IsAvailable = true, Prerequisite = "Beginner and Intermediate Salsa", SkillLevel = 4, Teachers = new List<Teacher> { tchr }, Time = new TimeSpan(12, 00, 00), Duration = new TimeSpan(3, 00, 00), Recurring = true, Frequency = Frequency.Weekly, Day = DayOfWeek.Sunday, Interval = 1 });
            context.Events.AddRange(salsaworkshops);
